...
/* ร้านที่ตั้งใจรับเงินด้วยการโอนอย่างเดียว ต้องไม่โดนเตือนว่า "ยังไม่ได้กรอก" ทุกใบ
   คำเตือนที่ขึ้นทุกวันโดยไม่มีอะไรให้ทำ คือคำเตือนที่คนเลิกอ่าน แล้ววันที่มีเรื่องจริงจะถูกมองข้าม */
eq('ถือว่าเป็นการตั้งใจปิด QR ไม่ใช่ตั้งค่าค้าง', ask3d.qrOff, true);
truthy('ไม่มีคำว่า "ยังไม่ได้กรอก" ในข้อความที่ขึ้นให้เห็น',
  ask3d.qrWhy.indexOf('ยังไม่ได้กรอก') < 0);
truthy('แต่ยังบอกทางเปิดใช้ไว้ให้ เผื่อวันหนึ่งเปลี่ยนใจ',
  ask3d.qrWhy.indexOf('พร้อมเพย์') > -1);
eq('ส่วนกรณีที่ยังไม่ได้กรอกเลขบัญชีจริง ๆ ยังต้องเป็นคำเตือนเหมือนเดิม',
   ask3c.qrOff, false);
